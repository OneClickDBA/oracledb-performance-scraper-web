...
```text
Allow group harry-scraper-users to read secret-bundles in compartment observability
```
...
```text
Allow dynamic-group harry-scraper-instances to read secret-bundles in compartment observability
```
...
```text
Allow dynamic-group harry-scraper-resources to read secret-bundles in compartment observability
```
...
Allow any-user to read secret-bundles in compartment observability where all {
  ...
  request.principal.service_account = 'harry-scraper',
...
Allow dynamic-group harry-scraper-instances to read secret-bundles in compartment observability
  where target.secret.name = 'harry-scraper-db-password'
```
